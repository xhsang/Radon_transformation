...
NTTW_DLL_SYM void ifrt2(fftw_complex *bins, fftw_complex *result, fftw_complex *Isum, const int p, const int norm);
/**
...
NTTW_DLL_SYM nttw_integer ifrt_dyadic_unsample(nttw_integer *bins, long *result, nttw_big_integer *sampling, const int n, const int norm);

/**
 * \fn nrt(nttw_integer *field, nttw_integer *bins, const size_t p)
 * \brief
 * The Number-Theoretic Radon Transform (NRT) of Chandra, 2009 for 2D arrays. Number-Theoretic Slice Theorem version.
 * Complexity is linear logarithmic in time (same as a prime length 2D FFT).
 * \author Shekhar S. Chandra, 2009
 * \param field Contains the data to be transformed. Must be p by p array.
 * \param bins It is assumed that this is already a pointer that has
 * memory is allocated for each bin. The function only does internal
 * initializing with no allocation. It must have size of p+1 by n.
 * \param p The prime size which is the size of the square array.
*/
NTTW_DLL_SYM void nrt(nttw_integer *field, nttw_integer *bins, const size_t p);
NTTW_DLL_SYM void nrt2(nttw_integer *field, nttw_integer *nttOfBins, const size_t p, const nttw_integer root, const nttw_integer modulus, const nttw_integer proot);
/**
 * \fn nrt_dyadic(nttw_integer *field, nttw_integer *bins, const size_t n)
 * \brief
 * The Dyadic Number-Theoretic Radon Transform (NRT) of Chandra, 2009 for 2D arrays. Number-Theoretic Slice Theorem version.
 * Complexity is linear logarithmic in time (same as a 2D FFT).
 * \author Shekhar S. Chandra, 2009
 * \param field Contains the data to be transformed. Must be n by n array.
 * \param bins It is assumed that this is already a pointer that has
 ...
 * \param n The dyadic size which is the size of the square array.
*/
NTTW_DLL_SYM void nrt_dyadic(nttw_integer *field, nttw_integer *bins, const size_t n);

/**
 * \fn inrt(nttw_integer *bins, nttw_integer *result, const int p, const int norm)
 * \brief
 * The Inverse Number-Theoretic Radon Transform (iNRT) of Chandra, 2009 for 2D arrays. Number-Theoretic Slice Theorem version.
 * Complexity is linear logarithmic in time (same as a 2D FFT). This is for prime lengths.
 * \author Shekhar S. Chandra, 2009
 * \param bins Contains the data to be inverse transformed and should be of
 * size p+1 by p.
 ...
 * \param norm Normalise the result?
*/
NTTW_DLL_SYM nttw_integer inrt(nttw_integer *bins, nttw_integer *result, const int p, const int norm);
/**
 * \fn inrt2(nttw_integer *bins, nttw_integer *result, const int p, const nttw_integer root, const nttw_integer modulus, const nttw_integer proot, const int norm)
 * \brief
 * The Inverse Number-Theoretic Radon Transform (iNRT) of Chandra, 2009 for 2D arrays. Number-Theoretic Slice Theorem version.
 * Complexity is linear logarithmic in time (same as a 2D FFT). This is for prime lengths.
 *
 * This routine assumes bins contain slices (i.e., NTT of projections) and that root and modulus are provided.
 * \author Shekhar S. Chandra, 2009
 * \param bins Contains the slice data to be inverse transformed and should be of
 * size p+1 by p.
 * \param result It is assumed that this is already a pointer that has
 * memory is allocated for each pixel. The function only does internal
 * initializing with no allocation. It must have size of p by p.
 ...
 * \param norm Normalise the result?
*/
NTTW_DLL_SYM nttw_integer inrt2(nttw_integer *bins, nttw_integer *result, const int p, const nttw_integer root, const
 nttw_integer modulus, const nttw_integer proot, const int norm);
/**
 * \fn inrt_dyadic(nttw_integer *bins, nttw_integer *result, const size_t n, const int norm)
 * \brief
 * The Inverse Dyadic Number-Theoretic Radon Transform (NRT) of Chandra, 2009 for 2D arrays. Number-Theoretic Slice Theorem version.
 * Complexity is linear logarithmic in time (same as a 2D FFT).
 * \author Shekhar S. Chandra, 2009
 * \param bins Contains the data to be inverse transformed. Must be n by n+n/2 array.
 * \param result The recontructed image. It must have size of n by n.
 * \param n The dyadic size which is the size of the square array.
*/
NTTW_DLL_SYM nttw_integer inrt_dyadic(nttw_integer *bins, nttw_integer *result, const size_t n, const int norm);
...
NTTW_DLL_SYM void getSlice_Integer(const size_t m, const nttw_integer *data, nttw_integer *slice, const size_t size);
/**
...
NTTW_DLL_SYM void getSlice_Perp_Integer(const size_t s, const nttw_integer *data, nttw_integer *slice, const size_t size);
...
NTTW_DLL_SYM void setSlice_Integer(const size_t m, nttw_integer *data, const nttw_integer *slice, const size_t size, const nttw_integer modulus);
/**
...
NTTW_DLL_SYM void setSlice_Perp_Integer(const size_t s, nttw_integer *data, const nttw_integer *slice, const size_t size, const nttw_integer modulus);
...
NTTW_DLL_SYM void dyadic_1D_filter_Integer(nttw_big_integer *data, const size_t n, const nttw_integer modulus);
/**
...
NTTW_DLL_SYM void filter_oversampling_Integer(nttw_integer *data, nttw_integer *filter, const int n, const nttw_integer modulus);
